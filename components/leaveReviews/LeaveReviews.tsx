  ...
  return (
    <div>
      <div className="flex justify-between mb-11 items-center w-350 h-38 rounded-[20px] border border-[#00000040]/25 shadow-lg ">
        ...
        <button className="w-71 h-12 mr-21 bg-[#E48C3F] rounded-[15px] text-white font-medium text-2xl cursor-pointer hover:bg-[#E48C3F]/90 transform transition-transform hover:scale-105 duration-300">
          Оставить свой отзыв
        </button>
      </div>
    </div>
